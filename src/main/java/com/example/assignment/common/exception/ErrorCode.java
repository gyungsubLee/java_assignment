...
import com.example.assignment.common.exception.custom.InvalidEmailOrPasswordException;
...
public enum ErrorCode {
    ...
    INVALID_CREDENTIALS(Category.MEMBER, HttpStatus.UNAUTHORIZED, "M002", "아이디 또는 비밀번호가 올바르지 않습니다.", InvalidEmailOrPasswordException.class),
